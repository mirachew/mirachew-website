...
A rapid-turn fabrication project supporting the Formula SAE team’s suspension data collection system.  
I fabricated the pull-rod load-cell links that measure real-time wheel loads during track testing, with a focus on concentric fixturing, thread integrity, and controlled TIG welding so the parts would install cleanly on the car.
...
**TIG welding (4130 and mild steel)** | **tapping and threading** | **concentric fixturing** | **SolidWorks manufacturability review** | **motorsport hardware integration** | **suspension test instrumentation**
